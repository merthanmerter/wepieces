export const MESSAGES = {
  ...
  saved: (name: string) => `${capitalize(name)} saved successfully`,
  savedError: (name: string) => `Failed to save ${name}`,
  duplicated: (name: string) => `${capitalize(name)} duplicated successfully`,
  duplicatedError: (name: string) => `Failed to duplicate ${name}`,
  deleted: (name: string) => `${capitalize(name)} deleted successfully`,
  deletedError: (name: string) => `Failed to delete ${name}`,
